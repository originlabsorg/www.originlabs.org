        ...
        <section id = "two" >
            <div className = "inner">
              <div className = "row">
                ...
                <div className="logo" style={{backgroundImage: `url(${gfl})`}}></div>
                </a>
                <a href="https://www.blackbird.us">
                <div className="logo" style={{backgroundImage: `url(${blackbird})`}}></div>
                </a>
                <a href="https://www.trunkclub.com">
                  <div className="logo" style={{backgroundImage: `url(${trunkclub})`}}></div>
                </a>
                <a href="https://www.usetrusted.com">
                  <div className="logo" style={{backgroundImage: `url(${trusted})`}}></div>
                </a>
                <a href="https://www.persistiq.com">
                  <div className="logo" style={{backgroundImage: `url(${persist})`}}></div>
                </a>
